...
static void taskbar_configure(Plugin * p, GtkWindow * parent)
{
    ...
    GtkWidget* dlg = create_generic_config_dlg(
        ...
        _("Appearance"), (gpointer)NULL, CONF_TYPE_BEGIN_PAGE,

        _("|Show:|Icons only|Titles only|Icons and titles"), (gpointer)&tb->show_icons_titles, CONF_TYPE_ENUM,
        _("Show tooltips"), (gpointer)&tb->tooltips, CONF_TYPE_BOOL,
        _("Show close buttons"), (gpointer)&tb->show_close_buttons, CONF_TYPE_BOOL,
        _("Flat buttons"), (gpointer)&tb->flat_button, CONF_TYPE_BOOL,
        _("Highlight modified titles"), (gpointer)&tb->highlight_modified_titles, CONF_TYPE_BOOL,
        "", 0, CONF_TYPE_BEGIN_TABLE,
        _("Maximum width of task button"), (gpointer)&tb->task_width_max, CONF_TYPE_INT,
        "int-min-value", (gpointer)&min_width_max, CONF_TYPE_SET_PROPERTY,
        "int-max-value", (gpointer)&max_width_max, CONF_TYPE_SET_PROPERTY,
        _("Spacing"), (gpointer)&tb->spacing, CONF_TYPE_INT,
        "int-max-value", (gpointer)&max_spacing, CONF_TYPE_SET_PROPERTY,
        _("Use group separators"), (gpointer)&tb->use_group_separators, CONF_TYPE_BOOL,
        _("Group separator size"), (gpointer)&tb->group_separator_size, CONF_TYPE_INT,
        "int-max-value", (gpointer)&max_group_separator_size, CONF_TYPE_SET_PROPERTY,
        "", 0, CONF_TYPE_END_TABLE,

        _("Behavior"), (gpointer)NULL, CONF_TYPE_BEGIN_PAGE,

        "", 0, CONF_TYPE_BEGIN_TABLE,
        _("|Mode|Classic|Group windows|Show only active window"), (gpointer)&tb->mode, CONF_TYPE_ENUM,
        _("|Group by|None|Window class|Workspace|Window state"), (gpointer)&tb->group_by, CONF_TYPE_ENUM,
        //_("Group fold threshold"), (gpointer)&tb->group_fold_threshold, CONF_TYPE_INT,
        _("Fold group when it has Nr windows"), (gpointer)&tb->group_fold_threshold, CONF_TYPE_INT,
        _("Fold groups when taskbar has Nr windows"), (gpointer)&tb->panel_fold_threshold, CONF_TYPE_INT,
        _("Unfold focused group"), (gpointer)&tb->unfold_focused_group, CONF_TYPE_BOOL,
	_("Show only focused group"), (gpointer)&tb->show_single_group, CONF_TYPE_BOOL,
        _("Manual grouping"), (gpointer)&tb->manual_grouping, CONF_TYPE_BOOL,
        "", 0, CONF_TYPE_END_TABLE,

        _("Show iconified windows"), (gpointer)&tb->show_iconified, CONF_TYPE_BOOL,
        _("Show mapped windows"), (gpointer)&tb->show_mapped, CONF_TYPE_BOOL,
        _("Show windows from all desktops"), (gpointer)&tb->show_all_desks, CONF_TYPE_BOOL,

        _("Flash when there is any window requiring attention"), (gpointer)&tb->use_urgency_hint, CONF_TYPE_BOOL,

        _("Sorting"), (gpointer)NULL, CONF_TYPE_BEGIN_PAGE,
        "", 0, CONF_TYPE_BEGIN_TABLE,
        sort_by_1, (gpointer)&tb->sort_by[0], CONF_TYPE_ENUM,
        sort_by_2, (gpointer)&tb->sort_by[1], CONF_TYPE_ENUM,
        sort_by_3, (gpointer)&tb->sort_by[2], CONF_TYPE_ENUM,
        "", 0, CONF_TYPE_END_TABLE,
        _("Rearrange manually"), (gpointer)&tb->rearrange, CONF_TYPE_BOOL,

        _("Bindings"), (gpointer)NULL, CONF_TYPE_BEGIN_PAGE,

        "", 0, CONF_TYPE_BEGIN_TABLE,
        button1_action, (gpointer)&tb->button1_action, CONF_TYPE_ENUM,
        button2_action, (gpointer)&tb->button2_action, CONF_TYPE_ENUM,
        button3_action, (gpointer)&tb->button3_action, CONF_TYPE_ENUM,
        scroll_up_action, (gpointer)&tb->scroll_up_action, CONF_TYPE_ENUM,
        scroll_down_action, (gpointer)&tb->scroll_down_action, CONF_TYPE_ENUM,
        shift_button1_action, (gpointer)&tb->shift_button1_action, CONF_TYPE_ENUM,
        shift_button2_action, (gpointer)&tb->shift_button2_action, CONF_TYPE_ENUM,
        shift_button3_action, (gpointer)&tb->shift_button3_action, CONF_TYPE_ENUM,
        shift_scroll_up_action, (gpointer)&tb->shift_scroll_up_action, CONF_TYPE_ENUM,
        shift_scroll_down_action, (gpointer)&tb->shift_scroll_down_action, CONF_TYPE_ENUM,
        "", 0, CONF_TYPE_END_TABLE,

//        _("Response for mouse clicks or drag:"), (gpointer)NULL, CONF_TYPE_TITLE,
        "", 0, CONF_TYPE_BEGIN_TABLE,
        menu_actions_click_press, (gpointer)&tb->menu_actions_click_press, CONF_TYPE_ENUM,
        other_actions_click_press, (gpointer)&tb->other_actions_click_press, CONF_TYPE_ENUM,
        "", 0, CONF_TYPE_END_TABLE,
