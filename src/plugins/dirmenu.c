...
static void dirmenu_configure(Plugin * p, GtkWindow * parent)
{
    ...
    GtkWidget * dlg = create_generic_config_dlg(
        ...
        _("Show hidden files or folders"), &dm->show_hidden, CONF_TYPE_BOOL,
        _("Show files"), &dm->show_files, CONF_TYPE_BOOL,
        _("Use submenu if number of files is more than"), &dm->max_file_count, CONF_TYPE_INT,
        _("Show file size"), &dm->show_file_size, CONF_TYPE_BOOL,
        "", 0, CONF_TYPE_BEGIN_TABLE,
        sort_directories, (gpointer)&dm->sort_directories, CONF_TYPE_ENUM,
        sort_files, (gpointer)&dm->sort_files, CONF_TYPE_ENUM,
        "", 0, CONF_TYPE_END_TABLE,
        NULL);
